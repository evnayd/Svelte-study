    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li0, file, 68, 1, 1784);
    			...
    			add_location(li1, file, 69, 1, 1969);
    			...
    			add_location(li2, file, 70, 1, 2153);
    			...
    			add_location(button1, file, 74, 0, 2522);

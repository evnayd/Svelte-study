    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "absolute bottom-3 right-1 text-gray-300 hover:text-gray-400 outline-none border-none");
    			...
    			add_location(li0, file, 68, 1, 1772);
    			...
    			add_location(li1, file, 69, 1, 1957);
    			...
    			add_location(li2, file, 70, 1, 2141);
    			...
    			add_location(button1, file, 74, 0, 2510);
    			attr_dev(div1, "class", "bg-white w-full  md:w-2/3 mx-auto shadow-md p-6 xl:p-14 text-left sm:text-center my-16 lg:my-32");
